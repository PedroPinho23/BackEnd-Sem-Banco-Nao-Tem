...
public class CadastroBDTeste {
    ...
    public static void main(String[] args)throws Exception {
        ...
        PessoaFisica pessoaIncluir = new PessoaFisica(seq.getValue("seq_Pessoa"),"Pedro", "Rua centro, Centro", 
        "São Paulo", "SP", "9999-9999","99999999@9999999.com","99999999999");
       ...
       pessoaPF1.alterar( 3,  "99999999999",  "Pedro",  "", "",  "", "999999999",  "");
      ...
      PessoaJuridica pessoaIncluir2 = new PessoaJuridica(seq.getValue("seq_Pessoa"),"99999 LTDA",
            "Rua centro, Centro","Belo Horizonte", "MG", "9999-9999","99999999@9999999.com","55555555555555");
      ...
      pessoaPJ2.alterar( 4,  "99999999999999",  "99999 LTDA ",  "", "",  "", "",  "");
